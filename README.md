...
The current MVP is being tested in Telegram. Internal validation includes 140 automated checks covering target conditions, navigation, alert delivery, access controls, request limits and payment handling. Payment checks use simulated Telegram responses; live checkout validation is still pending.
